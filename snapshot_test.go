...
func TestCopySnapshot(t *testing.T) {
	...
	testConf.client.getAPI().(*mocks.Client).ExpectedCalls = nil
	ctx := context.Background()
	testConf.client.getAPI().(*mocks.Client).On("DoWithHeaders", mock.Anything, mock.Anything, mock.Anything, mock.Anything, mock.Anything, mock.AnythingOfType("*types.CopySnapshots")).Return(nil).
		Run(func(args mock.Arguments) {
