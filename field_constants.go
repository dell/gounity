...
const (
	...
	ConsistencyGroupDisplayFields = "id,name,description,type,sizeTotal,sizeUsed,sizeAllocated,pools,isThinClone,parentSnap,health,isReplicationDestination,replicationType,syncReplicationType,luns"
