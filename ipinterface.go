...
func (c *UnityClientImpl) ListIscsiIPInterfaces(ctx context.Context) ([]apitypes.IPInterfaceEntries, error) {
	log := gounityutil.GetRunIDLogger(ctx)
	hResponse := &apitypes.ListIPInterfaces{}
	...
	var iscsiInterfaces []apitypes.IPInterfaceEntries
